...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_src_backend_hook__ = __webpack_require__(218);


Object(__WEBPACK_IMPORTED_MODULE_0_src_backend_hook__["a" /* installHook */])(window)
...
function installHook (window) {
  ...
  hook.once('init', function (Vue) {
    ...
    Vue.prototype.$inspect = function () {
      var fn = window.__VUE_DEVTOOLS_INSPECT__
      fn && fn(this)
    }
  })
